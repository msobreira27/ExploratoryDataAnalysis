...
targetData$Global_reactive_power <- as.numeric(targetData$Global_reactive_power)
...
plot(targetData$Time, targetData$Voltage, type="l", xlab = "datetime", ylab = "Voltage")
...
plot(targetData$Time, targetData$Global_reactive_power, type="l", xlab="datetime", ylab ="Global_reactive_power")
dev.off()